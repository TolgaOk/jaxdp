...
class train(metaclass=StaticMeta):
    ...
    @staticmethod
    def asynchronous(sampler_state: SamplerState,
                     init_value: QType,
                     mdp: MDP,
                     key: KeyType,
                     learner_state: Any,
                     ...
                     update_fn: Callable[[int, RolloutSample, QType, Any, float], Tuple[QType, Any]],
        ...
        def _log_fn(sampler_state, metrics, step_data):
            ...
            policy_evaluation = train.eval_policy(mdp, target_policy, gamma)
        ...
        def _step_fn(index, step_data):
            ...
            next_value, learner_state = update_fn(
                index, rollout_sample, value, learner_state, gamma)
    ...
    @staticmethod
    def synchronous(init_value: QType,
                    mdp: MDP,
                    key: KeyType,
                    learner_state: Any,
                    value_star: QType,
