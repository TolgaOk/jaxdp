...
class value_iteration(metaclass=StaticMeta):
    ...
    @register_as("q")
    def update(mdp: MDP, value: QType, gamma: float) -> QType:
        # TODO: Add docstring
        # TODO: Add test
        # TODO: Add citation
    ...
    @register_as("v")
    def update(mdp: MDP, value: VType, gamma: float) -> VType:
        # TODO: Add docstring
        # TODO: Add test
        # TODO: Add citation
        non_done = (1 - mdp.terminal)
...
class nesterov_vi(metaclass=StaticMeta):
    ...
    @register_as("q")
    def init(mdp: MDP, init_value: QType, gamma: float, key: KeyType):
        return init_value
...
class quasi_policy_iteration(metaclass=StaticMeta):
    ...
    @register_as("v")
    def init(mdp: MDP, init_value: VType, gamma: float, key: KeyType):
        raise NotADirectoryError
